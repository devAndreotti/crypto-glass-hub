                  ...
                  <button
                    ...
                    className={`group flex items-center space-x-3 w-full px-3 py-2 rounded-lg text-left transition-all duration-300 hover:scale-[1.02] hover:-translate-y-0.5 ${
                      currentSort === option.value
                        ? 'bg-crypto-red-medium/20 text-crypto-red-light border border-crypto-red-medium/30'
                        : 'hover:bg-white/10 text-foreground/80 hover:text-foreground border border-transparent hover:border-white/20'
                    }`}
                  >
